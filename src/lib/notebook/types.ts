/**
 * The scheduler contract for the Notebook component's reactive core
 * (issue #59). Semantics are specified in ./SPEC.md; the test suite in
 * ./suite.ts encodes that spec and runs against the implementation in
 * ./graph.ts.
 */
