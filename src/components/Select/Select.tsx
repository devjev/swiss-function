...
const Trigger = forwardRef<HTMLDivElement, ComponentPropsWithoutRef<typeof BaseSelect.Trigger>>(
  function SelectTrigger({ className, children, ...rest }, ref) {
    return (
      <BaseSelect.Trigger {...rest} ref={ref} className={cx(styles.trigger, className)}>
        {children}
...
const Popup = forwardRef<HTMLDivElement, ComponentPropsWithoutRef<typeof BaseSelect.Popup>>(
  function SelectPopup({ className, ...rest }, ref) {
    return <BaseSelect.Popup {...rest} ref={ref} className={cx(styles.popup, className)} />;
  },
);
...
const Item = forwardRef<HTMLDivElement, ComponentPropsWithoutRef<typeof BaseSelect.Item>>(
  function SelectItem({ className, ...rest }, ref) {
    return <BaseSelect.Item {...rest} ref={ref} className={cx(styles.item, className)} />;
  },
);
